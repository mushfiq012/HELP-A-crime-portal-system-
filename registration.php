     ...
     function f1()
        {
            ...
            var sta4=document.getElementById("idno").value;
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">id Number</p><input type="text"  name="id_number" minlength="16" maxlength="16" id="idno" onfocusout="f1()"/>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" minlength="11" maxlength="11" id="mobno" onfocusout="f1()"/>
					</div>
