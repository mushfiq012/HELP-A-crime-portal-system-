...
<body style="color: black;background-image: url(supremecourt.jpg);background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:black">HQ Id</h1></label>
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Portal C191056</b></h4>
</div>
